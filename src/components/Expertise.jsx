...
<motion.div
 key={(index)} className="flex items-center border-b-4
...
variants="ItemVariants">
    ...
    className="h-auto rounded-3xl"/>
        ...
        <div className="pl-8">
            <h3 className="text-2xl uppercase tracking-tighter text-red-600">
                {cusine.title}
            </h3>
            <p className="mt-4 text-lg tracking-tighter">{cusine.description}
            </p>
            </div>
    </motion.div>
        ))}
